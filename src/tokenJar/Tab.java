...
public class Tab extends javax.swing.JPanel implements ITab, TableModelListener{    
    ...
    private void removeTokenActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    private void openRegexWindowActionPerformed(java.awt.event.ActionEvent evt) {                                                
    ...
    private void masterEnableActionPerformed(java.awt.event.ActionEvent evt) {                                             
    ...
    private void masterDebugActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    private void exportConfActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void goToSite1MouseClicked(java.awt.event.MouseEvent evt) {                                       
        showGettingStartedDialog();
    }                                      

    private void masterProxyActionPerformed(java.awt.event.ActionEvent evt) {                                            
        dataModel.setMasterProxy(masterProxy.isSelected());   
    }                                           

    private void masterIntruderActionPerformed(java.awt.event.ActionEvent evt) {                                               
        dataModel.setMasterIntruder(masterIntruder.isSelected());
    }                                              

    private void masterRepeaterActionPerformed(java.awt.event.ActionEvent evt) {                                               
